...
import com.grippo.design.resources.provider.goal_primary_build_muscle_desc
import com.grippo.design.resources.provider.goal_primary_general_fitness
import com.grippo.design.resources.provider.goal_primary_general_fitness_desc
import com.grippo.design.resources.provider.goal_primary_get_stronger
import com.grippo.design.resources.provider.goal_primary_get_stronger_desc
import com.grippo.design.resources.provider.goal_primary_lose_fat
import com.grippo.design.resources.provider.goal_primary_lose_fat_desc
import com.grippo.design.resources.provider.goal_primary_maintain
import com.grippo.design.resources.provider.goal_primary_maintain_desc
import com.grippo.design.resources.provider.goal_primary_return_to_training
import com.grippo.design.resources.provider.goal_primary_return_to_training_desc
...
public enum class GoalPrimaryGoalEnumState {
    ...
    public fun description(): String {
        return when (this) {
            BUILD_MUSCLE -> AppTokens.strings.res(Res.string.goal_primary_build_muscle_desc)
            GET_STRONGER -> AppTokens.strings.res(Res.string.goal_primary_get_stronger_desc)
            LOSE_FAT -> AppTokens.strings.res(Res.string.goal_primary_lose_fat_desc)
            RETURN_TO_TRAINING -> AppTokens.strings.res(Res.string.goal_primary_return_to_training_desc)
            MAINTAIN -> AppTokens.strings.res(Res.string.goal_primary_maintain_desc)
            GENERAL_FITNESS -> AppTokens.strings.res(Res.string.goal_primary_general_fitness_desc)
        }
    }
}
