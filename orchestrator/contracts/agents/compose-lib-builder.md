# Contract: agents/compose-lib-builder

Frozen per-agent contract. Source of truth: the `platform-build-toolkit` skill; this record pins the role's stable surface.

## Identity (pinned)
- name: `compose-lib-builder`
- kind: `builder`
