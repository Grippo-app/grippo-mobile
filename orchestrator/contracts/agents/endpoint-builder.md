# Contract: agents/endpoint-builder

Frozen per-agent contract. Source of truth: the `backend-contract-client` skill; this record pins the role's stable surface.
