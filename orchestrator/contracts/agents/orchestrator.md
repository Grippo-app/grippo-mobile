# Contract: agents/orchestrator

Frozen per-agent contract. Source of truth: the `task-orchestrator` skill; this record pins the role's stable surface.

## Identity (pinned)
- name: `orchestrator`
- kind: `helper`
- tools (permission boundary): `Read, Edit, Write, Bash, Grep, Glob, Agent`
- model: `opus`
