# Contract: agents/ui-core-state-builder

Frozen per-agent contract. Source of truth: the `ui-feature` skill; this record pins the role's stable surface.

## Identity (pinned)
- name: `ui-core-state-builder`
- kind: `builder`
