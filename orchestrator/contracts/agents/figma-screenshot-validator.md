# Contract: agents/figma-screenshot-validator

Frozen per-agent contract. Source of truth: the `validation-gates` skill; this record pins the role's stable surface.

## Identity (pinned)
- name: `figma-screenshot-validator`
- kind: `validator`
