package com.grippo.design.components.metrics.distribution
...
import com.grippo.core.state.metrics.distribution.stubCategoryDistribution
import com.grippo.core.state.metrics.distribution.stubForceDistribution
import com.grippo.core.state.metrics.distribution.stubWeightDistribution
...
private fun <T> ExerciseDistributionChartContent(
    ...
    Column(
        ...
        val chartMinSize = AppTokens.dp.metrics.distribution.chart.size
