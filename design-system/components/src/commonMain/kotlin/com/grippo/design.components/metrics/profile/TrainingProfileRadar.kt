...
import com.grippo.core.state.metrics.profile.TrainingDimensionScoreState
...
public fun TrainingProfileRadar(
    ...
    val size = when (style) {
        TrainingProfileRadarStyle.SMALL -> AppTokens.dp.metrics.profile.trainingProfile.radar.small.size
        TrainingProfileRadarStyle.LARGE -> AppTokens.dp.metrics.profile.trainingProfile.radar.large.size
    }
