...
public val AppIcon.SidebarCollapse: ImageVector
    get() {
        if (_SidebarCollapse != null) {
            return _SidebarCollapse!!
        }
        _SidebarCollapse = ImageVector.Builder(
...
private var _SidebarCollapse: ImageVector? = null
