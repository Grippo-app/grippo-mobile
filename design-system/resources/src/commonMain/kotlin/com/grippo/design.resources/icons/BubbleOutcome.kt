...
public val AppIcon.BubbleOutcome: ImageVector
    get() {
        if (_BubbleOutcome != null) {
            return _BubbleOutcome!!
        }
        _BubbleOutcome = ImageVector.Builder(
            name = "BubbleOutcome",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _BubbleOutcome: ImageVector? = null
