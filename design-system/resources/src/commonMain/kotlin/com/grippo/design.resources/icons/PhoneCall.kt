...
public val AppIcon.PhoneCall: ImageVector
    get() {
        if (_PhoneCall != null) {
            return _PhoneCall!!
        }
        _PhoneCall = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(15.05f, 5f)
                curveTo(16.027f, 5.191f, 16.924f, 5.668f, 17.628f, 6.372f)
                curveTo(18.332f, 7.076f, 18.809f, 7.973f, 19f, 8.95f)
                lineTo(15.05f, 5f)
                close()
                moveTo(15.05f, 1f)
                curveTo(17.079f, 1.225f, 18.972f, 2.134f, 20.416f, 3.577f)
                curveTo(21.861f, 5.02f, 22.772f, 6.911f, 23f, 8.94f)
                lineTo(15.05f, 1f)
                close()
                moveTo(22f, 16.92f)
                ...
                curveTo(2.095f, 3.903f, 2.128f, 3.625f, 2.216f, 3.362f)
                ...
                curveTo(9.237f, 4.68f, 9.471f, 5.623f, 9.81f, 6.53f)
                curveTo(9.945f, 6.888f, 9.974f, 7.277f, 9.894f, 7.651f)
                curveTo(9.814f, 8.025f, 9.629f, 8.368f, 9.36f, 8.64f)
                lineTo(8.09f, 9.91f)
                curveTo(9.514f, 12.413f, 11.586f, 14.486f, 14.09f, 15.91f)
                lineTo(15.36f, 14.64f)
                curveTo(15.632f, 14.371f, 15.975f, 14.186f, 16.349f, 14.106f)
                curveTo(16.723f, 14.026f, 17.112f, 14.056f, 17.47f, 14.19f)
                curveTo(18.377f, 14.529f, 19.32f, 14.763f, 20.28f, 14.89f)
