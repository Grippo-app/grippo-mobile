...
public val AppIcon.BubbleWarning: ImageVector
    get() {
        if (_BubbleWarning != null) {
            return _BubbleWarning!!
        }
        _BubbleWarning = ImageVector.Builder(
            name = "BubbleWarning",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _BubbleWarning: ImageVector? = null
