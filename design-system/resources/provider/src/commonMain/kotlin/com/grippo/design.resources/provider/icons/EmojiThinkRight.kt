...
public val AppIcon.EmojiThinkRight: ImageVector
    get() {
        if (_EmojiThinkRight != null) {
            return _EmojiThinkRight!!
        }
        _EmojiThinkRight = ImageVector.Builder(
            name = "EmojiThinkRight",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _EmojiThinkRight: ImageVector? = null
