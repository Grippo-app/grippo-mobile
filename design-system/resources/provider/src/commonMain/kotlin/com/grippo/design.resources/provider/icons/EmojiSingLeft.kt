...
public val AppIcon.EmojiSingLeft: ImageVector
    get() {
        if (_EmojiSingLeft != null) {
            return _EmojiSingLeft!!
        }
        _EmojiSingLeft = ImageVector.Builder(
            name = "EmojiSingLeft",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _EmojiSingLeft: ImageVector? = null
