...
public val AppIcon.FastArrowUpBox: ImageVector
    get() {
        if (_FastArrowUpBox != null) {
            return _FastArrowUpBox!!
        }
        _FastArrowUpBox = ImageVector.Builder(
            name = "FastArrowUpBox",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _FastArrowUpBox: ImageVector? = null
