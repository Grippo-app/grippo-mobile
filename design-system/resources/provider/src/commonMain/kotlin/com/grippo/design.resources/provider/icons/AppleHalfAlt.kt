...
public val AppIcon.AppleHalfAlt: ImageVector
    get() {
        if (_AppleHalfAlt != null) {
            return _AppleHalfAlt!!
        }
        _AppleHalfAlt = ImageVector.Builder(
            name = "AppleHalfAlt",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _AppleHalfAlt: ImageVector? = null
