...
public val AppIcon.BubbleDownload: ImageVector
    get() {
        if (_BubbleDownload != null) {
            return _BubbleDownload!!
        }
        _BubbleDownload = ImageVector.Builder(
            name = "BubbleDownload",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _BubbleDownload: ImageVector? = null
