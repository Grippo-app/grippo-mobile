...
public val AppIcon.ShoppingBagArrowDown: ImageVector
    get() {
        if (_ShoppingBagArrowDown != null) {
            return _ShoppingBagArrowDown!!
        }
        _ShoppingBagArrowDown = ImageVector.Builder(
            name = "ShoppingBagArrowDown",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ShoppingBagArrowDown: ImageVector? = null
