...
public val AppIcon.StatsSquareUp: ImageVector
    get() {
        if (_StatsSquareUp != null) {
            return _StatsSquareUp!!
        }
        _StatsSquareUp = ImageVector.Builder(
            name = "StatsSquareUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _StatsSquareUp: ImageVector? = null
