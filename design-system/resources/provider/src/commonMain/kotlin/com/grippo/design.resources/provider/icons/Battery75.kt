...
public val AppIcon.Battery75: ImageVector
    get() {
        if (_Battery75 != null) {
            return _Battery75!!
        }
        _Battery75 = ImageVector.Builder(
            name = "Battery75",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(
                ...
                curveTo(13.731f, 9f, 14f, 9.269f, 14f, 9.6f)
                verticalLineTo(14.4f)
                curveTo(14f, 14.731f, 13.731f, 15f, 13.4f, 15f)
...
private var _Battery75: ImageVector? = null
