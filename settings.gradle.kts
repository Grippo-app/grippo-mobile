...
include(":data-features:local-settings")
...
include(":ui-dialog-features:confirm-training-completion")
include(":ui-dialog-features:weight-picker")
include(":ui-dialog-features:duration-picker")
...
include(":ui-dialog-features:muscle-loading-details")
include(":ui-dialog-features:training-streak-details")
include(":ui-dialog-features:performance-trend-details")
include(":ui-dialog-features:training-goal-details")
