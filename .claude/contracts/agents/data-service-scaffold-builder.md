# Contract: agents/data-service-scaffold-builder

Frozen per-agent contract. Source of truth: the `data-layer` skill; this record pins the role's stable surface.
