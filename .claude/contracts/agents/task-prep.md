...
- name: `task-prep`
- kind: `helper`
- tools (permission boundary): `Read, Write, Edit, Bash, Grep, Glob, Agent`
- model: `opus`
...
- immutable canonical `## Source` preservation across every body promotion;
