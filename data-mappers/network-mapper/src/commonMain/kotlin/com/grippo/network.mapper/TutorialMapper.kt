...
public fun TutorialDto.toEntityOrNull(): ExerciseTutorialEntity? {
    ...
    val entityExerciseExampleId = AppLogger.mapping(exerciseExampleId, { "TutorialDto.exerciseExampleId is null" }) ?: return null
    val entityTitle = AppLogger.mapping(title, { "TutorialDto.title is null" }) ?: return null
    val entityLanguage = AppLogger.mapping(language, { "TutorialDto.language is null" }) ?: return null
    val entityValue = AppLogger.mapping(value, { "TutorialDto.value is null" }) ?: return null
    val entityResourceType = AppLogger.mapping(resourceType, { "TutorialDto.resourceType is null" }) ?: return null
    val entityCreatedAt = AppLogger.mapping(createdAt, { "TutorialDto.createdAt is null" }) ?: return null
    val entityUpdatedAt = AppLogger.mapping(updatedAt, { "TutorialDto.updatedAt is null" }) ?: return null
