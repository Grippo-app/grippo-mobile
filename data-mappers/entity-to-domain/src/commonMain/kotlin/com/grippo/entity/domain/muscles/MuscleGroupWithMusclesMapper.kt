...
public fun List<com.grippo.services.database.models.MuscleGroupWithMuscles>.toDomain(): List<MuscleGroup> {
    return mapNotNull { it.toDomain() }
}

public fun com.grippo.services.database.models.MuscleGroupWithMuscles.toDomain(): MuscleGroup? {
